package com.vivien.shader.view;
...
import com.vivien.shader.R;

/**
 * Created by vivien on 17/1/13.
 */
...
public class RoundImageView extends ImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RoundImageView);//默认为10dp
